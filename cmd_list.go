...
//
// We filter kind clusters to show only those starting with the "astro-"
// prefix, ensuring only astrona-generated kind clusters are listed.
func listKindClusters() {
	...
	fmt.Println("  (filtered to show only astrona-generated kind clusters prefixed with 'astro-')")
}
